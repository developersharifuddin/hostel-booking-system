                ...
                <div class="row">
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Store Name..." id="name" value="{{ old('name', $storeData->name) }}" required disabled>
                            @error('name')
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="phone" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Enter phone..." id="phone" value="{{ old('phone',  $storeData->phone) }}" required disabled>
                            @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter Email..." id="email" value="{{ old('email',  $storeData->email) }}" required disabled>
                            @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="country" onchange="loadDistrict(this,'#district')" class="form-control @error('country') is-invalid @enderror" placeholder="" id="country" disabled>
                                ...
                                <option value="{{ $storeData->id }}" selected>
                                    {{ $storeData->name }}
                                </option>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="district" onchange="loadUpazila(this,'#upazila')" class="form-control @error('district') is-invalid @enderror" placeholder="Enter district.." id="district" disabled>
                                ...
                                <option value="{{$storeData->district}}" selected>{{$storeData->district_name}}</option>
                            </select>
                            @error('district')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="upazila" class="form-control @error('upazila') is-invalid @enderror" placeholder="Enter upazila.." id="upazila" disabled>
                                ...
                                <option value="{{$storeData->upazila}}" selected>{{$storeData->upazila_name}} </option>
                            </select>
                            @error('upazila')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="postcode" class="form-control @error('postcode') is-invalid @enderror" placeholder="Enter Postcode..." id="postcode" value="{{ old('postcode',  $storeData->postcode) }}" disabled>
                            @error('postcode')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <textarea name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Enter Address..." id="address" disabled>{{ old('address',  $storeData->address) }}</textarea>
                            @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
