...
<div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
    <div class="col-sm-6">
        ...
        <ol class="breadcrumb bg-white">
            <li class="breadcrumb-store"> <a href="{{ route('dashboard') }}" class="text-primary"><i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-store text-dark px-2"><a href="{{ route('hostels.index') }}"> hostels</a>
            </li>
        </ol>
    </div>
    <div class="col-md-6">
        <ol class="float-right button">
            <a href="{{ route('hostels.create') }}" class="btn btn-success" rel="tooltip" id="add" title="add">
                Add New
            </a>
        </ol>
    </div>
        ...
        <div class="card">
            <div class="card-header justify-content-between py-3">
                ...
                <div class="float-right d-flex my-auto gap-3">
                    ...
                    <form class="mb-0 pb-0" id="sort_hostels" action="" method="GET">
            ...
            <div class="card-body card-body p-0 table-responsive">
                <table id="example1" class="table table-hover">
                    <thead>
                        <tr>
                            <th>SL</th>
                            <th style="text-align: left !important; ">Store Name</th>
                            <th>Email</th>
                            <th>Phone Number</th>
                            <th>Address</th>
                            <th>Actions</th>
                    ...
                    <tbody id="datatable">
                        ...
                        <li>{{ $hostel->name }} - {{ $hostel->location }} (Available Rooms: {{ $hostel->available_rooms }})</li>
                        @endforeach
                        @else
                        <tr class="h-50">
                            <td colspan="13">
                    ...
                    <div class="pagination d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="dataTables_info pl-2">
                                Showing
                                <span id="showing-entries-from">{{ $hostels->firstItem() }}</span>
                                to
                                <span id="showing-entries-to">{{ $hostels->lastItem() }}</span>
                                of
                                <span id="total-entries">{{ $hostels->total() }}</span>
                                entries
                            </div>
                        </div>
                        <!-- ... (remaining content) -->
                        {{ $hostels->links('components.pagination.default') }}
                        {{-- {{ $hostels->appends(request()->except('page'))->links() }} --}}
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
